...
- [Project Origins](#project-origins-the-original-nefasto-generator-late-1980s)
...
## Project Origins: The Original Nefasto Generator (Late 1980s)

This project was inspired by a real discourse generator built at **Universidad de Antioquia** in Medellín in the late 1980s. Here's the story, shared by Prof. Fabian Rios (who built the original):

### The Original System

> The program was a simple combination of 10 columns, randomly taking one case in each one of them which in turn were homogeneous with 10 options. I programmed it using "Turbo Prolog" produced by a company that is now defunct—Borland. The language was very similar to production rules, and because of that I adopted it for several investigations, such as prototyping and later development of LEXICO, a didactic language for introductory computing with objects, which I'm now porting to Android.

### The Nefasto Bocazza Backstory

Each discourse generated by the original program was "signed" by a fictional author: **Nefasto Bocazza** (originally named **Necfardo Bocazza** after "Nec," the brand of the first PC purchased by the Systems Engineering Department on the initiative of Prof. Mario Jaramillo).

Prof. Roberto Flores, who administered the department's Texas Instruments computer, ran the program daily, printed each discourse, and posted it on the professors' bulletin board. **It was a humorous response to the university's politically-talkative faculty who produced "so much discourse and so little action."**

This satire—hidden in seemingly earnest academic discourse—became a beloved tradition in the department, and the fictional author "Nefasto" took on a life of its own.
...
Where `rnd` was a random function the computer provided. Unfortunately, the original code is lost to time, but this project revives that spirit: **pure logic, simple rules, and narratives that emerge from constraint rather than complexity.**
